                    ...
                    <div className="w-full md:w-2/5 flex flex-col divide-y-2 space-y-8">
                        <div className="space-y-8">
                            <div className="flex justify-between ">
                                <h1 className="font-display text-2xl md:text-5xl text-gray-800">
                                    {product.name}
                                </h1>
                                <p className="font-body text-lg md:text-xl text-gray-800">
                                    ${product.price}
                                </p>
                            </div>
                            ...
                            <div>
                                <p className="font-body leading-relaxed text-gray-700">
                                    The {product.name} is a beautiful, statement
                                    piece product that brings style and
                                    brightness to any indoor space. This product
                                    requires{" "}
                            ...
                            <div className="flex">
                                ...
                                <FontAwesomeIcon
                                    ...
                                    icon={faStar}
                                />
                                <p className="font-display font-light text-sm text-gray-600 tracking-wider pl-2 underline cursor-pointer hover:text-gray-900">
                                    7,329 Reviews
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            <h2 className="font-body font-semibold mt-4 text-gray-800">
                                Ceramic Pot Color
                            </h2>
                        ...
                        <div className="flex-col space-y-5">
                            ...
                            <div className="flex-col space-y-5">
                                <div className="flex">
                                    <FontAwesomeIcon
                                        ...
                                        icon={faSun}
                                    />
                                    <p className="font-body ml-2 text-gray-700">
                                        {product.light}
                                    </p>
                                </div>
                                <div>
                            ...
                            <div className="flex justify-around pt-4">
                                <p className="w-24 font-body text-gray-600 hover:text-gray-900">
                                    Made to order
                                </p>
                                <p className="w-24 font-body text-gray-600 hover:text-gray-900">
                                    60 Day Guarantee
