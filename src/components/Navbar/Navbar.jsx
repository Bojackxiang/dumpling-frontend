...
const Navbar = () => {
  return (
    <nav className="flex text-black bg-gray-100 h-24 items-center">
      <Link to="/">
        <h1 className="item-center transform duration-300 hover:-translate-y-1 font-display font-thin tracking-wide m-auto pl-4 md:pl-12 text-2xl md:text-5xl">
          Dumpling
        </h1>
      </Link>
