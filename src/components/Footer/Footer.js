...
function Footer() {
    return (
        <footer className="bg-gray-200 bg-opacity-40 w-screen pt-8 pb-28">
            <div
                className="flex flex-col md:flex-row justify-center w-5/6 2xl:w-7/12 m-auto justify-between
            ...
            >
                <div className="text-center md:text-left m-auto w-full md:w-0">
                    ...
                    <p className="font-body py-4 w-72 text-gray-700">
                        Get plant care tips and tricks delivered straight to
                        your mailbox.
                    </p>
                    <div className="flex mt-6">
                        ...
                        ></input>
                        <button
                            className="h-12 p-4 w-28 font-body text-sm bg-gray-900 text-white rounded-r
                ...
                <div className="flex space-x-6 md:space-x-24">
                    <div className="flex flex-col space-y-4">
                        ...
                        <Link
                            className="font-body text-gray-700 text-sm md:text-base flex-col space-y-4"
                            to="/about"
                        >
                            <p>About Us</p>
                            <p>FAQ</p>
                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        <div className="flex space-x-6">
                            ...
                            >
                                <FontAwesomeIcon
                                    className="text-xl md:text-2xl text-gray-700 hover:text-gray-900"
                                    icon={faGithub}
                                />
                            </a>
                            <a
